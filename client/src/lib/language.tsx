...
const translations = {
  en: {
    ...
    "intro.popup.subtitle": "Animal Discovered. Save Your Journey.",
    "intro.popup.message": "Register and simply scan all the QR codes on all 24 photos here by renowned Emirati photographer H.E. Ali bin Thalith for a chance to win:",
  ...
  ar: {
    ...
    "intro.popup.subtitle": "تم اكتشاف حيوان. احفظ رحلتك.",
    "intro.popup.message": "سجّل وامسح جميع رموز QR على الصور الـ 24 هنا للمصور الإماراتي الشهير معالي علي بن ثالث للحصول على فرصة للفوز بـ:",
