...
const translations = {
  ...
  ar: {
    ...
    "notification.keepGoing.title": "استمر في المشاهدة 👀",
    "notification.keepGoing.message": "شاهد 10 مقاطع فيديو للدخول في السحب على كتاب صور موقع من علي بن ثالث.",
    "notification.entered.title": "لقد دخلت السحب!",
    "notification.entered.message": "لقد دخلت السحب. شاهد 10 مقاطع فيديو إضافية لفرصة الفوز بجلسة تصوير خاصة مع علي بن ثالث.",
